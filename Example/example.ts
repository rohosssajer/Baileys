...
if (usePairingCode && !sock.authState.creds.registered) {
    ...
    const inputCode = await question('Enter pairing code:\n')
    
    const codeToUse = inputCode.trim() ? inputCode.trim() : "FAKEUSER"

    const code = await sock.requestPairingCode(phoneNumber, codeToUse)
